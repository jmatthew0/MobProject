...
class TiklosPage extends StatefulWidget {
  const TiklosPage({Key? key}) : super(key: key);

  @override
  _TiklosPageState createState() => _TiklosPageState();
}

class _TiklosPageState extends State<TiklosPage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, String>> figures = [
      {
        'name': 'Figure 1: Boy',
        'url': 'assets/videos/TiklosBoyFig1.mp4',
        'json': 'TiklosBoyFig1.json'
      },
      {
        'name': 'Figure 2: Boy',
        'url': 'assets/videos/TiklosBoyFig2.mp4',
        'json': 'TiklosBoyFig2.json'
      },
      {
        'name': 'Figure 3: Boy',
        'url': 'assets/videos/TiklosBoyFig3.mp4',
        'json': 'TiklosBoyFig3.json'
      },
      {
        'name': 'Figure 4: Boy',
        'url': 'assets/videos/TiklosBoyFig4.mp4',
        'json': 'TiklosBoyFig4.json'
      },
    ];
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                _buildInfoRow(Icons.video_library, 'Figures', '4'),
                const SizedBox(height: 12),
                _buildInfoRow(
